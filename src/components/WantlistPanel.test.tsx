...
describe('WantlistPanel', () => {
    ...
    const createMockReleaseElement = (artist: string, title: string, releaseId: string, isWantlist: boolean = true): HTMLElement => {
    ...
    it('diagnostic: WantlistPanel\'s show function works', async () => {
        ...
        const showFn = (elem: HTMLElement) => { elem.classList.remove("hidden"); };
    ...
    it('should hide duplicate items when "Unique items" button is clicked', async () => {
        ...
        await act(async () => { // Wrap interaction that triggers state update and re-render
