...
describe('CollectionPanel', () => {
    ...
    let useMutationConfigOnSuccess: Function; // To capture onSuccess from config
    let useMutationConfigOnError: Function; // To capture onError from config
    ...
    it('should render dynamic dropdowns for dropdown custom fields', () => {
        ...
        expect(screen.getByRole('option', { name: '-- Select Media Condition --' })).toBeInTheDocument();
